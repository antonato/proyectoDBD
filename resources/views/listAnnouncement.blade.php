                ...
                <div id="category" alt="categoría" class="yellow w-25 h-75">
                    <div id="group-category" class="d-flex flex-column">
                        ...
                        <div class="ind-category d-flex align-items-center">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\new.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Lo Último</h5>
                        </div>
                        <div class="ind-category d-flex align-items-center">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\tools.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Herramientas</h5>
                        </div>
                        <div class="ind-category d-flex align-items-center">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\build.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Inmobiliaria</h5>
                        </div>
                        <div class="ind-category d-flex align-items-center">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\movil.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Vehículos</h5>
                        </div>
                        <div class="ind-category d-flex align-items-center">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\party.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Espacios</h5>
                        </div>
                        <div class="ind-category d-flex align-items-center mb-4 round">
                            <img class="mr-3 mb-0" src="{{ asset('assets\icons\service.svg') }}" alt="icono" width="33px" height="33px" />
                            <h5>Artículos</h5>
                        </div>
                    </div>
                </div>
                            ...
                            @foreach ($announcement as $item)
                                ...
                                <div class="d-flex mt-2 mb-2 announcement justify-content-between w-100 align-items-center">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h6 alt="Título Anuncio">{{$item->NameProduct}}</h6>
                                            <h5 class="price" alt="Título Anuncio">${{$item->Price}}</h5>
